# ============================================================
# SCRIPT: Build y Deploy Completo de Actifisio
# ============================================================
# Este script hace todo el proceso de build y deploy en un solo comando
# ============================================================

Write-Host "🚀 ============================================" -ForegroundColor Cyan
Write-Host "   BUILD Y DEPLOY: ACTIFISIO" -ForegroundColor Cyan
Write-Host "   ============================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path "dist\actifisio-build") {
    Remove-Item -Path "dist\actifisio-build" -Recurse -Force
...
Write-Host "🔨 Construyendo Actifisio..." -ForegroundColor Yellow
...
$indexPath = "dist\actifisio-build\browser\index.csr.html"

if (Test-Path $indexPath) {
    $html = Get-Content $indexPath -Raw
    $injection = "  <script>window.__CLIENT_ID = 'actifisio';</script>`n"
...
Set-Content -Path "dist\actifisio-build\browser\vercel.json" -Value $vercelJson
...
Set-Location -Path "dist\actifisio-build\browser"
...
# 7. Actualizar alias
Write-Host "🔗 Actualizando alias actifisio.vercel.app..." -ForegroundColor Yellow
$aliasOutput = vercel alias set $deploymentUrl actifisio.vercel.app 2>&1 | Out-String
...
Write-Host "   Producción: https://actifisio.vercel.app" -ForegroundColor White
Write-Host "   Deployment: $deploymentUrl" -ForegroundColor Gray
Write-Host ""
Write-Host "🧪 Testing:" -ForegroundColor Cyan
Write-Host "   1. Abre: https://actifisio.vercel.app" -ForegroundColor White
