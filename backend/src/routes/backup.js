...
// GET /api/backup/stats - Obtener estadÃ­sticas de backups
...
router.post('/restore/:fileName', async (req, res, next) => {
    ...
    return res.status(400).json({
        success: false,
        message: 'No se realizÃ³ la restauraciÃ³n automÃ¡tica. Descargue el archivo e importe manualmente (pg_restore, psql o revise el JSON). Para permitir importaciÃ³n automÃ¡tica en producciÃ³n, establezca ALLOW_AUTO_RESTORE=true en el entorno o configure RESTORE_SECRET y envÃ­e X-Restore-Secret en la peticiÃ³n. En desarrollo puede usar ?force=true o enviar {"force":true}.',
